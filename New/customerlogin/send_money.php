...
<li class="active " ><a href="http://localhost/new/customerlogin/send_money.php">Send_money</a></li>
...
<div align ="center">
  <tr>
	...
	<tr>
    <td><br/><h1 style="color: #F706F0; font-size:18px;">Transection amount :</h1></td>
    <td><input type="text" size="32" maxlength="32" name="send_amount"placeholder="Enter your amount "required></td>
	</tr>
