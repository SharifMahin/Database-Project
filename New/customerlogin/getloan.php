...
<img src="e.png">
	...
	<li class="active "><a href="http://localhost/new/customerlogin/getloan.php">Get_loan</a></li>
...
<div align ="center">
  <tr>
	...
	<tr>
    <td><br/><h1 style="color: #F706F0; font-size:18px;">loan No :</h1></td>
    ...
    <td><input type="text" size="32" maxlength="32" name="loan_amount"placeholder="Enter your Amount "required></td>
	</tr>
</table>
  <tr>
...
<?php
   ...
   if(isset($_POST['submit'])){
		 ...
		 $get = $_POST['loan_amount'];
		 $query="update loan set loan_amount = loan_amount+'$get' where  loan_no='$loan_no'";
         $query1="update borrower set loan_amount = loan_amount+'$get' where  loan_no='$loan_no'";		 
		 $run = mysqli_query($con,$query);
		 $run1 = mysqli_query($con,$query1);
	 		   echo"
			 <script>
			 alert('loan request pending.');
